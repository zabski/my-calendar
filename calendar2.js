	var CALENDAR = function () { 
	    var wrap, label, current_month, current_year;
	    ...
	    function init(newWrap) { 
			...
			wrap.find("#next_month_btn").bind("click.calendar", function () { switchMonth(true);  }); 
	    ...
	    function switchMonth(next, month, year) { 
			...
			month = month || ((next) ? ( (current_month === 11) ? 0 : current_month + 1 ) : ( (current_month === 0) ? 11 : current_month - 1 )); 
	    ...
	    function createCal(year, month) { 
			...
			*/
			...
			month_tag = $(month_id);
			var month_string = document.getElementById(month_id).textContent;
			//month_string = month_tag.text;
			createCal.cache[year][month] = { calendar : function () { return calendar.clone() }, label : month_string + " " + year };
